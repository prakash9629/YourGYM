...
const TermsOfService = () => {
  ...
  const sectionsData = t('terms.sections', { returnObjects: true }) || [];
    ...
    <div className="min-h-screen bg-white dark:bg-[#050505] pt-32 pb-24 text-start">
      <div className="container-custom max-w-4xl">
        <Link to="/" className="inline-flex items-center gap-2 text-brand font-bold uppercase tracking-widest text-xs mb-12 hover:gap-4 transition-all">
          <ChevronLeft size={16} className={cn(isRTL && "rotate-180")} /> {t('terms.back')}
        </Link>
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-black text-[#0A0A0A] dark:text-white uppercase tracking-tighter">{t('terms.title')}</h1>
              <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px]">{t('terms.lastUpdated')}</p>
            </div>
          </div>
          ...
          <div className="space-y-12 text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <section className="pt-8 border-t border-gray-200 dark:border-white/10 text-center">
